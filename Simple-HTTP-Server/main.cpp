...
const int thread_num = 8; // 執行緒池執行緒數目
const short port = 9000; // 網路埠號
const int MAX_FD = 65536; // 最大檔案符號數量
const int MAX_EVENT_NUMBER = 10000; // 最大並發事件處理數
